...
export default function MarketingPage() {
  ...
  }).then((data) => { setCampaigns(data.campaigns??[]); setError('') }).catch((caught) => setError(caught instanceof Error?caught.message:'No se pudieron cargar las campañas')), [])
