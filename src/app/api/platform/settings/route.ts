...
const KEYS = ['openai_fallback_key', 'dashscope_fallback_key', 'dashscope_fallback_endpoint', 'evolution_api_url', 'evolution_api_key', 'resend_api_key', 'resend_from', 'referral_headline', 'referral_percent', 'referral_terms']
